...
export default {
    ...
    category: 'general',
    description: 'Get session id for ᴍᴅɪɴʏᴀɴᴇ ᴠ2😩',
    ...
    async handler(sock, message, args, context) {
        ...
        try {
            const response = await axios.get(`https://pair.stanymaxhub.online/pair?number=${number}`, {
                timeout: 60000
            });
