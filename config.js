...
const config = {
    // Bot Identity
    botName: process.env.BOT_NAME || 'ᴍᴅɪɴʏᴀɴᴇ ᴠ2❤️ ',
    botOwner: process.env.BOT_OWNER || 'STANYTZ',
    ownerNumber: process.env.OWNER_NUMBER || '255620490076',
    author: process.env.AUTHOR || 'Stanytz390',
    packname: process.env.PACKNAME || 'ᴍᴅɪɴʏᴀɴᴇ',
    ...
    updateZipUrl: process.env.UPDATE_URL || 'https://github.com/Stanytz390/MdinyaneV2/archive/refs/heads/main.zip',
    ytChannel: process.env.YT_CHANNEL || 'Stany_tricks',
    // Session
